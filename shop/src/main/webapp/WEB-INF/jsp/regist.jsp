	...
	var check = {
	    userName:function(){
            $("#username").blur(function(){
                ...
                $("#span1").load(
                    "${pageContext.request.contextPath}/user/checkUsername?"+new Date().getTime(),
                    {'username':username}
                );
            })
		}
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20"  value="${user.username}"/>
										<span id="span1" >${errfields.get("username")}</span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off" value="${user.password}"/>
										<span class="mySpan">${errfields.get("password")}
									</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200" value="${user.email}"/>
										<span class="mySpan">
										${errfields.get("email")}
									</span></td>
								</tr>
								<tr>
									...
									<td><input type="text" id="phone" name="phone"
										class="text" maxlength="200" value="${user.phone}"/>
										<span class="mySpan">${errfields.get("phone")}</span>
									</td>
								...
								<tr>
									...
									</label> </span><span class="mySpan">${errfields.get("sex")}</span></td>
								</tr>
								...
								<tr>
									...
									</span><span class="mySpan">${msg}</span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
