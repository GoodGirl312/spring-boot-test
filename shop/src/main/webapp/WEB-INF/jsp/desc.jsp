...
<link rel="stylesheet" type="text/css" href="http://news.sina.com.cn/css/87/20140926/comment.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.8.3.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/number.js"></script>
<script src="http://slide.fashion.sina.com.cn/js/v1/slide.recommender.js?t=20160711"></script>
</head>
<body>
...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span6">
			<div class="hotProductCategory">
				...
				<c:forEach items="${categorylist}" var="cat">
					<dl>
						<dt>
							<a href="${pageContext.request.contextPath}/product/findByCid?cid=${cat.cid}&page=1">${cat.cname}</a>
						</dt>
						<!-- 二级分类显示 -->
						<c:forEach var="cs" items="${cat.categorySeconds}">
							<dd>
								<a href="${pageContext.request.contextPath}/product/findByCsid?csid=${cs.csid}&page=1">${cs.csname}</a>
							</dd>
		...
		<div class="span18 last">
			...
			<form id="form2" action="${ pageContext.request.contextPath }/cart/addCart" method="post">
						...
						<dl class="quantity">
							...
							<dd>
								<input  onclick="num('+')" value="+"/>
								 <input width="22px" height="18px" name="count" value="1" maxlength="4" onpaste="return false;" type="text"/>
								<input  onclick="num('-')" value="-"/>
							</dd>
