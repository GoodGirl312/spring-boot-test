...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="${pageContext.request.contextPath }/order/payOrder" method="post">
				<input type="hidden" name="oid" value="${order.oid}"/>
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="${order.user.addr}" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${order.user.name}" style="width:150px" />
								<br /> 
