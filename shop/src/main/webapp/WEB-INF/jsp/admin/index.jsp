...
<form method="post" action="${pageContext.request.contextPath }/adminUser/login" name='theForm' onsubmit="return validate()">
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
        <td colspan="2" align="right">&raquo; <a href="../" style="color:white">返回首页</a> &raquo;
          <a href="get_password.php?act=forget_pwd" style="color:white">您忘记了密码吗?</a></td>
      </tr>
      </table>
    </td>
  </tr>
